...
export const BOTTOMNAV_ITEMS = {
  student: [
    ...
    { id: "notifications", path: "/student/notifications", labelKey: "notifications.title", icon: FaBell },
    { id: "profile", path: "/student/profile", labelKey: "navbar.profile", icon: FaUsers },
    { id: "settings", path: "/student/settings", labelKey: "navbar.settings", icon: FaCog },
  ],
  tutor: [
    ...
    { id: "notifications", path: "/tutor/notifications", labelKey: "notifications.title", icon: FaBell },
    { id: "profile", path: "/tutor/profile", labelKey: "navbar.profile", icon: FaUsers },
    { id: "settings", path: "/tutor/settings", labelKey: "navbar.settings", icon: FaCog },
  ],
  admin: [
    ...
    { id: "notifications", path: "/admin/notifications", labelKey: "notifications.title", icon: FaBell },
